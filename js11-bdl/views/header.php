...
<body>
    <div class="container">
        ...
        <nav class="navbar">
            ...
            <a href="index.php?action=department_stats" class="nav-link">Statistik
                Departemen</a>
            ...
            <a href="index.php?action=employee_overview" class="nav-link">Ringkasan Gaji Karyawan</a>
            <a href="index.php?action=refresh" class="nav-link">Refresh
                Dashboard</a>
        </nav>
